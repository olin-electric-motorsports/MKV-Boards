...
U 1 1 5D58E505
P 1150 1500
F 0 "C3" V 1200 1350 50  0000 L CNN
F 1 "C_100pF" V 1000 1320 50  0000 L CNN
F 2 "footprints:C_0805_OEM" H 1188 1350 50  0001 C CNN
F 3 "https://katalog.we-online.de/pbs/datasheet/885012007057.pdf" H 1175 1600 50  0001 C CNN
F 4 "DK" H 1150 1500 60  0001 C CNN "MFN"
F 5 "732-7852-1-ND" H 1150 1500 60  0001 C CNN "MPN"
F 6 "https://www.digikey.com/product-detail/en/wurth-electronics-inc/885012007057/732-7852-1-ND/5454479" H 1575 2000 60  0001 C CNN "PurchasingLink"
	1    1150 1500
	1    0    0    -1  
$EndComp
$Comp
...
U 1 1 5D5EB7F3
P 4350 3550
F 0 "R3" V 4270 3550 50  0000 C CNN
F 1 "R_10K" V 4400 3800 50  0000 C CNN
F 2 "footprints:R_0805_OEM" H 4280 3550 50  0001 C CNN
F 3 "http://www.bourns.com/data/global/pdfs/CRS.pdf" H 4430 3550 50  0001 C CNN
F 4 "DK" H 4350 3550 60  0001 C CNN "MFN"
F 5 "CRS0805-FX-1002ELFCT-ND" H 4350 3550 60  0001 C CNN "MPN"
F 6 "https://www.digikey.com/products/en?keywords=CRS0805-FX-1002ELFCT-ND" H 4830 3950 60  0001 C CNN "PurchasingLink"
	1    4350 3550
	0    1    1    0   
$EndComp
$Comp
...
F 1 "VCC" H 4760 3460 50  0000 C CNN
...
U 1 1 5DB7F701
P 5850 2200
F 0 "J2" H 5808 3547 60  0000 C CNN
F 1 "MM_F_RA_20" H 5808 3441 60  0000 C CNN
F 2 "footprints:micromatch_female_ra_20" H 5650 3300 60  0001 C CNN
F 3 "http://www.te.com/commerce/DocumentDelivery/DDEController?Action=srchrtrv&DocNm=338070&DocType=Customer+Drawing&DocLang=English&DocFormat=pdf&PartCntxt=2-338070-0" H 5750 3400 60  0001 C CNN
F 4 "TE" H 5950 3600 60  0001 C CNN "MFN"
F 5 "2-338070-0" H 6050 3700 60  0001 C CNN "MPN"
F 6 "http://www.te.com/usa-en/product-2-338070-0.html" H 5850 3500 60  0001 C CNN "PurchasingLink"
	1    5850 2200
	1    0    0    -1  
$EndComp
...
U 1 1 5DB9FDB3
P 6200 4650
F 0 "Q1" H 6406 4696 50  0000 L CNN
F 1 "SSM3K333R" H 6406 4605 50  0000 L CNN
F 2 "footprints:SOT-23F" H 6400 4575 50  0001 L CIN
F 3 "https://drive.google.com/drive/folders/0B-V-iZf33Y4GNzhDQTJZanJRbVk" H 6400 4725 50  0001 L CNN
F 4 "DK" H 6700 5025 60  0001 C CNN "MFN"
F 5 "SSM3K333RLFCT-ND" H 6600 4925 60  0001 C CNN "MPN"
F 6 "https://www.digikey.com/product-detail/en/toshiba-semiconductor-and-storage/SSM3K333RLF/SSM3K333RLFCT-ND/3522391" H 6500 4825 60  0001 C CNN "PurchasingLink"
	1    6200 4650
	1    0    0    -1  
$EndComp
...
U 1 1 5DBF4B0C
P 8250 4750
F 0 "D2" H 8243 4495 50  0000 C CNN
F 1 "LED_0805" H 8243 4586 50  0000 C CNN
F 2 "footprints:LED_0805_OEM" H 8150 4750 50  0001 C CNN
F 3 "http://www.osram-os.com/Graphics/XPic9/00078860_0.pdf" H 8250 4850 50  0001 C CNN
F 4 "DK" H 8250 4750 60  0001 C CNN "MFN"
F 5 "475-1410-1-ND" H 8250 4750 60  0001 C CNN "MPN"
F 6 "https://www.digikey.com/products/en?keywords=475-1410-1-ND" H 8650 5250 60  0001 C CNN "PurchasingLink"
	1    8250 4750
	-1   0    0    1   
$EndComp
$Comp
...
U 1 1 5DBF5315
P 8250 5100
F 0 "D3" H 8243 4845 50  0000 C CNN
F 1 "LED_0805" H 8243 4936 50  0000 C CNN
F 2 "footprints:LED_0805_OEM" H 8150 5100 50  0001 C CNN
F 3 "http://www.osram-os.com/Graphics/XPic9/00078860_0.pdf" H 8250 5200 50  0001 C CNN
F 4 "DK" H 8250 5100 60  0001 C CNN "MFN"
F 5 "475-1410-1-ND" H 8250 5100 60  0001 C CNN "MPN"
F 6 "https://www.digikey.com/products/en?keywords=475-1410-1-ND" H 8650 5600 60  0001 C CNN "PurchasingLink"
	1    8250 5100
	-1   0    0    1   
$EndComp
$Comp
...
U 1 1 5DBF4365
P 8250 4400
F 0 "D1" H 8243 4145 50  0000 C CNN
F 1 "LED_0805" H 8243 4236 50  0000 C CNN
F 2 "footprints:LED_0805_OEM" H 8150 4400 50  0001 C CNN
F 3 "http://www.osram-os.com/Graphics/XPic9/00078860_0.pdf" H 8250 4500 50  0001 C CNN
F 4 "DK" H 8250 4400 60  0001 C CNN "MFN"
F 5 "475-1410-1-ND" H 8250 4400 60  0001 C CNN "MPN"
F 6 "https://www.digikey.com/products/en?keywords=475-1410-1-ND" H 8650 4900 60  0001 C CNN "PurchasingLink"
	1    8250 4400
	-1   0    0    1   
$EndComp
$Comp
...
U 1 1 5DCAEC1D
P 7950 4400
F 0 "R4" V 8157 4400 50  0000 C CNN
F 1 "R_200" V 8066 4400 50  0000 C CNN
F 2 "footprints:R_0805_OEM" H 7880 4400 50  0001 C CNN
F 3 "https://www.seielect.com/Catalog/SEI-RMCF_RMCP.pdf" H 8030 4400 50  0001 C CNN
F 4 "DK" H 7950 4400 60  0001 C CNN "MFN"
F 5 "RMCF0805JT200RCT-ND" H 7950 4400 60  0001 C CNN "MPN"
F 6 "https://www.digikey.com/products/en?keywords=RMCF0805JT200RCT-ND" H 8430 4800 60  0001 C CNN "PurchasingLink"
	1    7950 4400
	0    -1   -1   0   
$EndComp
$Comp
...
U 1 1 5DCB5996
P 7950 4750
F 0 "R5" V 8157 4750 50  0000 C CNN
F 1 "R_200" V 8066 4750 50  0000 C CNN
F 2 "footprints:R_0805_OEM" H 7880 4750 50  0001 C CNN
F 3 "https://www.seielect.com/Catalog/SEI-RMCF_RMCP.pdf" H 8030 4750 50  0001 C CNN
F 4 "DK" H 7950 4750 60  0001 C CNN "MFN"
F 5 "RMCF0805JT200RCT-ND" H 7950 4750 60  0001 C CNN "MPN"
F 6 "https://www.digikey.com/products/en?keywords=RMCF0805JT200RCT-ND" H 8430 5150 60  0001 C CNN "PurchasingLink"
	1    7950 4750
	0    -1   -1   0   
$EndComp
$Comp
...
U 1 1 5DCB5DB7
P 7950 5100
F 0 "R6" V 8157 5100 50  0000 C CNN
F 1 "R_200" V 8066 5100 50  0000 C CNN
F 2 "footprints:R_0805_OEM" H 7880 5100 50  0001 C CNN
F 3 "https://www.seielect.com/Catalog/SEI-RMCF_RMCP.pdf" H 8030 5100 50  0001 C CNN
F 4 "DK" H 7950 5100 60  0001 C CNN "MFN"
F 5 "RMCF0805JT200RCT-ND" H 7950 5100 60  0001 C CNN "MPN"
F 6 "https://www.digikey.com/products/en?keywords=RMCF0805JT200RCT-ND" H 8430 5500 60  0001 C CNN "PurchasingLink"
	1    7950 5100
	0    -1   -1   0   
$EndComp
Wire Notes Line
...
U 1 1 5DCE9EE6
P 9400 4400
F 0 "R7" V 9607 4400 50  0000 C CNN
F 1 "R_200" V 9516 4400 50  0000 C CNN
F 2 "footprints:R_0805_OEM" H 9330 4400 50  0001 C CNN
F 3 "https://www.seielect.com/Catalog/SEI-RMCF_RMCP.pdf" H 9480 4400 50  0001 C CNN
F 4 "DK" H 9400 4400 60  0001 C CNN "MFN"
F 5 "RMCF0805JT200RCT-ND" H 9400 4400 60  0001 C CNN "MPN"
F 6 "https://www.digikey.com/products/en?keywords=RMCF0805JT200RCT-ND" H 9880 4800 60  0001 C CNN "PurchasingLink"
	1    9400 4400
	0    -1   -1   0   
$EndComp
$Comp
...
U 1 1 5DCEA5AD
P 9700 4400
F 0 "D4" H 9693 4145 50  0000 C CNN
F 1 "LED_0805" H 9693 4236 50  0000 C CNN
F 2 "footprints:LED_0805_OEM" H 9600 4400 50  0001 C CNN
F 3 "http://www.osram-os.com/Graphics/XPic9/00078860_0.pdf" H 9700 4500 50  0001 C CNN
F 4 "DK" H 9700 4400 60  0001 C CNN "MFN"
F 5 "475-1410-1-ND" H 9700 4400 60  0001 C CNN "MPN"
F 6 "https://www.digikey.com/products/en?keywords=475-1410-1-ND" H 10100 4900 60  0001 C CNN "PurchasingLink"
	1    9700 4400
	-1   0    0    1   
$EndComp
$Comp
...
U 1 1 5DCEADF0
P 9400 4750
F 0 "R8" V 9607 4750 50  0000 C CNN
F 1 "R_200" V 9516 4750 50  0000 C CNN
F 2 "footprints:R_0805_OEM" H 9330 4750 50  0001 C CNN
F 3 "https://www.seielect.com/Catalog/SEI-RMCF_RMCP.pdf" H 9480 4750 50  0001 C CNN
F 4 "DK" H 9400 4750 60  0001 C CNN "MFN"
F 5 "RMCF0805JT200RCT-ND" H 9400 4750 60  0001 C CNN "MPN"
F 6 "https://www.digikey.com/products/en?keywords=RMCF0805JT200RCT-ND" H 9880 5150 60  0001 C CNN "PurchasingLink"
	1    9400 4750
	0    -1   -1   0   
$EndComp
$Comp
...
U 1 1 5DCEB597
P 9400 5100
F 0 "R9" V 9607 5100 50  0000 C CNN
F 1 "R_200" V 9516 5100 50  0000 C CNN
F 2 "footprints:R_0805_OEM" H 9330 5100 50  0001 C CNN
F 3 "https://www.seielect.com/Catalog/SEI-RMCF_RMCP.pdf" H 9480 5100 50  0001 C CNN
F 4 "DK" H 9400 5100 60  0001 C CNN "MFN"
F 5 "RMCF0805JT200RCT-ND" H 9400 5100 60  0001 C CNN "MPN"
F 6 "https://www.digikey.com/products/en?keywords=RMCF0805JT200RCT-ND" H 9880 5500 60  0001 C CNN "PurchasingLink"
	1    9400 5100
	0    -1   -1   0   
$EndComp
$Comp
...
U 1 1 5DCEBB62
P 9700 4750
F 0 "D5" H 9693 4495 50  0000 C CNN
F 1 "LED_0805" H 9693 4586 50  0000 C CNN
F 2 "footprints:LED_0805_OEM" H 9600 4750 50  0001 C CNN
F 3 "http://www.osram-os.com/Graphics/XPic9/00078860_0.pdf" H 9700 4850 50  0001 C CNN
F 4 "DK" H 9700 4750 60  0001 C CNN "MFN"
F 5 "475-1410-1-ND" H 9700 4750 60  0001 C CNN "MPN"
F 6 "https://www.digikey.com/products/en?keywords=475-1410-1-ND" H 10100 5250 60  0001 C CNN "PurchasingLink"
	1    9700 4750
	-1   0    0    1   
$EndComp
$Comp
...
U 1 1 5DCEC269
P 9700 5100
F 0 "D6" H 9693 4845 50  0000 C CNN
F 1 "LED_0805" H 9693 4936 50  0000 C CNN
F 2 "footprints:LED_0805_OEM" H 9600 5100 50  0001 C CNN
F 3 "http://www.osram-os.com/Graphics/XPic9/00078860_0.pdf" H 9700 5200 50  0001 C CNN
F 4 "DK" H 9700 5100 60  0001 C CNN "MFN"
F 5 "475-1410-1-ND" H 9700 5100 60  0001 C CNN "MPN"
F 6 "https://www.digikey.com/products/en?keywords=475-1410-1-ND" H 10100 5600 60  0001 C CNN "PurchasingLink"
	1    9700 5100
	-1   0    0    1   
$EndComp
$Comp
...
U 1 1 5DCECA51
P 10150 5200
F 0 "#PWR021" H 10150 4950 50  0001 C CNN
...
Wire Notes Line
	10300 4050 10300 5450
Wire Notes Line
	10300 5450 8950 5450
Wire Notes Line
	8950 5450 8950 4050
Text Notes 7200 4000 0    89   ~ 0
SYSTEM STATUS LEDS\n
Text Notes 10300 4000 2    89   ~ 0
PROGRAMMING LEDS\n
Text Notes 6600 4250 2    89   ~ 0
PUMP CONTROL
Text Notes 5400 750  0    89   ~ 0
INPUT PINS\n
